...
lvda_pkg_url="https://raw.githubusercontent.com/jiz-citrix/XDLinuxVDA/master/binaries/XenDesktopVDA-7.12.0.375-1.el7_2.x86_64.rpm"
lvda_pkg_name=$(echo $lvda_pkg_url | sed -e "s#.*/\(.*\)\s*#\1#")

xdping_pkg_url="https://raw.githubusercontent.com/jiz-citrix/XDLinuxVDA/master/binaries/linux-xdping.gz"
xdping_pkg_name=$(echo $xdping_pkg_url | sed -e "s#.*/\(.*\)\s*#\1#")

kernel_module_compile_script_url="https://raw.githubusercontent.com/jiz-citrix/XDLinuxVDA/master/scripts/centos/compile_usb_modules.sh"
...
vhci_hcd_url="https://raw.githubusercontent.com/jiz-citrix/XDLinuxVDA/master/binaries/vhci-hcd-${vhci_hcd_version}.tar.bz2"
build_dir="/tmp"
